      ...
      <div className="flex backdrop-blur-sm bg-[#aed1b2a1] w-[90%] h-auto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        <div className="w-[100%] lg:w-[50%] p-4 sm:p-10">
          ...
          <h5 className="pt-[2rem]">
            ...
            explicabo, eligendi ullam magni iste sapiente possimus excepturi
            atque officia quae incidunt aut cupiditate reiciendis, veritatis
            odio omnis consequatur architecto pariatur cum, inventore tempore
